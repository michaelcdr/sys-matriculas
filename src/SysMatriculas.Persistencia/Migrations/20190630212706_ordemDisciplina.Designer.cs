...
namespace SysMatriculas.Persistencia.Migrations
{
    ...
    [Migration("20190630212706_ordemDisciplina")]
    partial class ordemDisciplina
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SysMatriculas.Dominio.CoRequisito", b =>
                {
                    ...
                    b.Property<int>("DisciplinaPaiId");

                    b.HasKey("CoRequisitosId");

                    b.HasIndex("DisciplinaId");

                    b.HasIndex("DisciplinaPaiId");
            ...
            modelBuilder.Entity("SysMatriculas.Dominio.Desempenho", b =>
                {
                    b.Property<int>("UsuarioDesempenhoId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("UsuarioDesempenhoId");

                    b.HasIndex("DisciplinaId");

                    b.HasIndex("UsuarioId");

                    b.ToTable("UsuariosDesempenhos");
                });
            ...
            modelBuilder.Entity("SysMatriculas.Dominio.Matricula", b =>
                {
            ...
            modelBuilder.Entity("SysMatriculas.Dominio.TipoDeUsuario", b =>
                {
            ...
            modelBuilder.Entity("SysMatriculas.Dominio.Usuario", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("SysMatriculas.Dominio.TipoDeUsuario")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SysMatriculas.Dominio.Usuario")
                        .WithMany()
            ...
            modelBuilder.Entity("SysMatriculas.Dominio.CoRequisito", b =>
                {
                    ...
                    b.HasOne("SysMatriculas.Dominio.Disciplina", "DisciplinaPai")
                        .WithMany("CoRequisitos")
                        .HasForeignKey("DisciplinaPaiId")
                        .OnDelete(DeleteBehavior.Restrict);
                });
            ...
            modelBuilder.Entity("SysMatriculas.Dominio.Desempenho", b =>
                {
                    ...
                    b.HasOne("SysMatriculas.Dominio.Usuario", "Usuario")
            ...
            modelBuilder.Entity("SysMatriculas.Dominio.PreRequisito", b =>
                {
                    b.HasOne("SysMatriculas.Dominio.Disciplina", "Disciplina")
                        .WithMany("DisciplinasOndeEPreRequisito")
                        .HasForeignKey("DisciplinaId")
                        .OnDelete(DeleteBehavior.Restrict);
