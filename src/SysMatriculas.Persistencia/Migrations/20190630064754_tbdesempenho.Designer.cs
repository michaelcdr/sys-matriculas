...
namespace SysMatriculas.Persistencia.Migrations
{
    ...
    [Migration("20190630064754_tbdesempenho")]
    partial class tbdesempenho
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SysMatriculas.Dominio.CurriculoUsuario", b =>
                {
                    b.Property<int>("CurriculoUsuarioId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("CurriculoUsuarioId");

                    b.HasIndex("CurriculoId");

                    b.HasIndex("UsuarioId");

                    b.ToTable("CurriculosDosUsuarios");
                });
            ...
            modelBuilder.Entity("SysMatriculas.Dominio.UsuarioDesempenho", b =>
                {
            ...
            modelBuilder.Entity("SysMatriculas.Dominio.CurriculoUsuario", b =>
                {
                    b.HasOne("SysMatriculas.Dominio.Curriculo", "Curriculo")
                        .WithMany("CurriculosDeUsuarios")
                        .HasForeignKey("CurriculoId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("SysMatriculas.Dominio.Models.Usuario", "Usuario")
                        .WithMany("Curriculos")
